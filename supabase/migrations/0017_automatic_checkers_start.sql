-- ============================================================
-- Checkers Online V2.6 UX, automatic Checkers start and first-move timer.
-- Run after 0016_checkers_online_platform.sql. Safe to re-run.
-- ============================================================

-- Rated matches now skip the manual ready check. Once an opponent is found,
-- both players see the opponent and a short 3-second synchronized countdown.
-- White receives 2 minutes for the first move; later turns remain 1 minute.
