-- Checkers Online V2.6 — presence, passive match offers and in-game reactions.
-- Safe to re-run.
...
insert into public.users (
  provider, provider_user_id, display_name, username, is_ai
) values
  ('ai', 'temur', 'Temur', null, true),
  ('ai', 'nilufar', 'Nilufar', null, true),
  ('ai', 'jasur', 'Jasur', null, true),
  ('ai', 'madina', 'Madina', null, true),
  ('ai', 'sardor', 'Sardor', null, true),
  ('ai', 'aziza', 'Aziza', null, true)
