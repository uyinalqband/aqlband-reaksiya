...
import { PlayIcon, SettingsIcon, BoltIcon, HistoryIcon, TrophyIcon } from '@/components/ui/icons';
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex shrink-0 gap-2">
          <button
            ...
            aria-label="Reyting"
            className="flex h-11 w-11 items-center justify-center rounded-full border border-ink-600 bg-ink-800 text-gold-400 active:bg-ink-700"
          >
          ...
          <button
            ...
            className="flex h-11 w-11 items-center justify-center rounded-full border border-ink-600 bg-ink-800 text-mist-300 active:bg-ink-700"
          >
