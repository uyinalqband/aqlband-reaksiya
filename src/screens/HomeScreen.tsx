...
import { PlayIcon, SettingsIcon, BoltIcon, HistoryIcon } from '@/components/ui/icons';
    ...
    <Screen>
      <div className="flex items-start justify-between">
        ...
        <button
          ...
          className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-ink-600 bg-ink-800 text-mist-300 active:bg-ink-700"
        >
