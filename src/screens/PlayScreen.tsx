...
export function PlayScreen() {
  ...
  const finishSession = useCallback((sessionConfig: GameSessionConfig) => {
    ...
    const opponent = consumeChallenge();
  ...
  }, [addAttempt, attempts, consumeChallenge]);
  ...
  const handleBack = config ? changeSettings : goHome;
  ...
  return (
    ...
    >
      <TopBar title="Reaksiya" onBack={changeSettings} />
