...
export const GAMES: readonly GameDefinition[] = [
  ...
  { id:'twenty-four', route:'/games/twenty-four', emoji:'24', titleKey:'games.twentyFour.title', descriptionKey:'games.twentyFour.description', instructionsKey:'games.twentyFour.instructions', category:'logic', metric:'duration_ms' },
  ...
  { id:'checkers-puzzle', route:'/games/checkers-puzzles', emoji:'♟️', titleKey:'games.checkersPuzzle.title', descriptionKey:'games.checkersPuzzle.description', instructionsKey:'games.checkersPuzzle.instructions', category:'logic', metric:'duration_ms' },
] as const;
