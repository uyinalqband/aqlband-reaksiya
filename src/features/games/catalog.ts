...
export const GAMES: readonly GameDefinition[] = [
  ...
  { id:'twenty-four', route:'/games/24-game', emoji:'🧮', titleKey:'games.twentyFour.title', descriptionKey:'games.twentyFour.description', instructionsKey:'games.twentyFour.instructions', category:'logic', metric:'duration_ms' },
  ...
  { id:'fifteen-puzzle', route:'/games/15-puzzle', emoji:'🧩', titleKey:'games.puzzle.title', descriptionKey:'games.puzzle.description', instructionsKey:'games.puzzle.instructions', category:'logic', metric:'duration_ms', customSetup:'puzzle' },
] as const;
