...
import { getFriendsLeaderboard as loadFriendsLeaderboard } from '@/services/leaderboardService';
...
/** Existing screen compatibility; both identity arguments are intentionally ignored. */
export async function getFriendsLeaderboard(
  _legacyMyUserId?: string,
  _legacyTelegramId?: number,
): Promise<LeaderboardRow[]> {
  return loadFriendsLeaderboard(100);
}
