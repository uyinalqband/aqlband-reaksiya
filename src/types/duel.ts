...
export interface DuelRow {
  ...
  /** Frozen at match creation: host is the white side. */
  checkers_host_skin?: string | null;
  /** Frozen at match creation: guest is the black side and owns the board skin. */
  checkers_guest_skin?: string | null;
  /** Frozen at match creation: host/white player's own piece skin. */
  checkers_host_piece_skin?: string | null;
  /** Frozen at match creation: guest/black player's own piece skin. */
