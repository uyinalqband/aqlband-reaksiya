    ...
    <AnimatePresence>
      {ceremony ? (
        <motion.div
          ...
          role="dialog"
          aria-modal="true"
          aria-label="Kunlik sandiq mukofoti"
        >
          <motion.div
          ...
          >
            ...
            >
              {ceremony.phase === 'opening' ? 'Sandiq ochilmoqda…' : 'Mukofot olindi!'}
            </motion.h2>
            <p className="relative mt-2 text-sm text-mist-500">
              {ceremony.phase === 'opening'
                ? 'Bugungi maqsadlar mukofoti tayyorlanmoqda'
                : `${ceremony.xp} XP hisobingizga qo‘shildi`}
            </p>
